 ...
 * (std.text.string's new/push/append/bytes/finish/with_cap, std.text.str's eq/is_empty/view, std.mem.raw's
 ...
 *   std.text.string.with_cap(c) = String( ptr: alloc(c), len: 0, cap: c )  (an empty String with cap c) */
