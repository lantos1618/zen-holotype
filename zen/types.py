...
# The pure type lattice (rendering, fitness, substitution/unification) is a leaf
# layer — re-exported here so `from zen.types import fits, subst, show, …` is
# unchanged. The inference core below builds on it.
from .types_lattice import (show, is_option, dir_fits, fits, subst, match_type,  # noqa: F401
                            solve_call, _numeric)
