...
receivers. Nested parentheses around scalar matches retain every arm's checks.
224 fitting values must survive GCC/Clang compilation and execution unchanged.
112 out-of-range inputs must be rejected by both
