...
impl Area for Sq { area = (x: Ptr<Sq>) i32 { x.s } }
impl Area for Rect { area = (x: Ptr<Rect>) i32 { x.w } }
impl Area for Circle { area = (x: Ptr<Circle>) i32 { x.r } }
impl Area for Tri { area = (x: Ptr<Tri>) i32 { x.b } }
